            ...
            <Card sx={{ margin: "1rem", height: 500 }}>
              ...
              <CardContent>
                ...
                <h6 style={{ color: "gray" }}>
                  ...
                  indígenas e da floresta amazônica, além de autor, roteirista,
                  produtor cultural e palestrante.
                </h6>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Card sx={{ margin: "1rem", height: 500 }}>
              ...
              <CardContent>
                ...
                <h6 style={{ color: "gray" }}>
                  O cacique, nascido no Mato Grosso, é respeitado por defender a
                  Amazônia e os povos indígenas da floresta. Em 2020, foi
